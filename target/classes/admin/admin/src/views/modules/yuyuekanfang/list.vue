		     ...
		     <template slot-scope="scope">
              ...
              <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('yuyuekanfang','查看') && contents.tableBtnIcon == 0" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">{{ contents.tableBtnFont == 1?'详情':'' }}</el-button>
                                                                <el-button v-if="isAuth('yuyuekanfang','签约') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="zaixianqianyueCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'签约':'' }}</el-button>
                <el-button v-if="isAuth('yuyuekanfang','签约') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="zaixianqianyueCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'签约':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yuyuekanfang','签约') && contents.tableBtnIcon == 0" type="success" size="mini" @click="zaixianqianyueCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'签约':'' }}</el-button>
